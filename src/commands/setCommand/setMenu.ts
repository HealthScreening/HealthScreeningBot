...
import { HSBMessageComponentInteraction, HSBSelectMenuInteraction } from "../../discordjs-overrides";
...
export default class SetMenu {
  ...
  public constructor(user: User, autoUserModel: AutoUser | null, autoDaysModel: AutoDays | null, devicesModel: Devices | null) {
    this.user = user;
  ...
  /* Row #3 */
  private readonly daySelect = new MessageSelectMenu().setCustomId("daySelect").setPlaceholder("Days to Generate Screening").setMinValues(1).setMaxValues(7).addOptions([
    {
      label: "Monday",
      value: "Monday"
    },
  ...
  /* Row #4 */
  private readonly enableEmailOnly = new MessageButton().setCustomId("enableEmailOnly").setLabel("Enable Email Only").setStyle("SUCCESS")
  private readonly disableEmailOnly = new MessageButton().setCustomId("disableEmailOnly").setLabel("Disable Email Only").setStyle("DANGER")
  private readonly enablePaused = new MessageButton().setCustomId("enablePaused").setLabel("Pause Health Screenings").setStyle("DANGER")
  private readonly disablePaused = new MessageButton().setCustomId("disablePaused").setLabel("Resume Health Screenings").setStyle("SUCCESS")
  ...
  private async generateEmbed(){
    return await generateProfileEmbed(this.user, this.autoUserModel || undefined, this.autoDaysModel || undefined, this.devicesModel || undefined)
  }
  ...
  private async onDaySelect(interaction: HSBSelectMenuInteraction){
    this.autoDaysModel!.onSunday = this.autoDaysModel!.onMonday = this.autoDaysModel!.onTuesday = this.autoDaysModel!.onWednesday = this.autoDaysModel!.onThursday = this.autoDaysModel!.onFriday = this.autoDaysModel!.onSaturday = false
  ...
  private async onDisableEmailOnly(interaction: HSBMessageComponentInteraction){
  ...
  private async onIncrement5Minutes(interaction: HSBMessageComponentInteraction){
  ...
  private async onDecrement5Minutes(interaction: HSBMessageComponentInteraction){
    this.autoUserModel!.minute -= 5;
  ...
  public enableDeviceRowOnly(){
    this.collector.addComponent(this.deviceSelect, (interaction) => this.onDeviceSelect.bind(this)(interaction.interaction as HSBSelectMenuInteraction))
  ...
  public loadAll(){
    ...
    this.collector.addComponent(this.typeSelect, (interaction) => this.onTypeSelect.bind(this)(interaction.interaction as HSBSelectMenuInteraction))
    this.collector.addComponent(this.daySelect, (interaction) => this.onDaySelect.bind(this)(interaction.interaction as HSBSelectMenuInteraction))
    this.collector.addActionRow(this.booleanActionRow, [
      (interaction) => this.onEnableEmailOnly.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
      (interaction) => this.onDisableEmailOnly.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
      async () => void 0,
      (interaction) => this.onEnablePaused.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
      (interaction) => this.onDisablePaused.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
    ])
    this.collector.addActionRow(this.timeActionRow, [
      (interaction) => this.onIncrement1Hour.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
      (interaction) => this.onDecrement1Hour.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
      async () => void 0,
      (interaction) => this.onIncrement5Minutes.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
      (interaction) => this.onDecrement5Minutes.bind(this)(interaction.interaction as HSBMessageComponentInteraction),
    ])
  }
