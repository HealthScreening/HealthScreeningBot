...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var firstName, lastName, email, isVaxxed, buffer, attachment, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, (0, produce_screenshot_1.generateScreenshot)(firstName, lastName, email, isVaxxed)];
                    case 4:
                        buffer = _a.sent();
                        attachment = new discord_js_1.MessageAttachment(buffer, "screenshot.png");
