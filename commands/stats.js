...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var guildSize, members, registeredPeople, embed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        guildSize = interaction.client.guilds.cache.size;
                        members = 0;
                        interaction.client.guilds.cache.forEach(function (value) {
                            members += value.memberCount;
                        });
                        return [4 /*yield*/, orm_1.Config.count()];
                    case 1:
                        registeredPeople = _a.sent();
                        embed = new discord_js_1.MessageEmbed()
                            ...
                            .setTimestamp(luxon_1.DateTime.local().toUTC().toMillis());
